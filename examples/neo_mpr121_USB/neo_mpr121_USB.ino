...
// License: GNU GPLv3
//
// Adapted by Telemaco Gallimberti
// Added support for standard ARDUINO MIDI USB
// Changed IRQ PIN for strange issue when reading touch on bluefruit
// Tested on Bluefruit
// ---------------------------------------------------------------------------
...
void midi(byte channel, byte command, byte arg1, byte arg2) {
  ...
  Serial.println("Praparing to send MIDI EVENT");
  
  MidiUSB.sendMIDI(event);
  MidiUSB.flush();
  Serial.println("Sended midi event");
}
